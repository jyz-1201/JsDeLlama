...
#SBATCH -p a100-long
#SBATCH -o ./outputs/multinode_RL_codellama_onetask_1003_7.out
...
LOG_PATH="./outputs/multinode_RL_codellama_onetask_1003_7.out"

# Set distributed launcher
export LAUNCHER="accelerate launch \
    --config_file /home/jiang.2896/config/deepspeed_zero2_config_PPO.yaml \
...
export SCRIPT="codes/trainers/ppo.py"
export SCRIPT_ARGS="configs/ppo/ppo_codellama_onetask_16epoch.json"
