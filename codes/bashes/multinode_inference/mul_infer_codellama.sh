...
#SBATCH -p a100
#SBATCH -o ./outputs/mul_inference_codellama_0111_2.out
...
LOG_PATH="./outputs/mul_inference_codellama_0111_2.out"
...
export SCRIPT_ARGS="configs/inference/infer_codellama.json"
