...
#SBATCH -p a100
#SBATCH -o ./outputs/mul_inference_codellama_onetask_2e4_16epoch_1beam.out
...
LOG_PATH="./outputs/mul_inference_codellama_onetask_2e4_16epoch_1beam.out"
...
export SCRIPT_ARGS="configs/inference/infer_codellama_sft_onetask_2e4.json"
